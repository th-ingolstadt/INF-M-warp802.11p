...
mcs_info_11ag = [...
	[0, 0,	1,  0,	0,	 48,  24];... % 6 Mbps
	[1, 0,	1,  0,	2,	 48,  36];... % 9 Mbps
	[2, 0,	1,  1,	0,	 96,  48];... %12 Mbps
	[3, 0,	1,  1,	2,	 96,  72];... %18 Mbps
	[4, 0,	1,  2,	0,	192,  96];... %24 Mbps
	[5, 0,	1,  2,	2,	192, 144];... %36 Mbps
	[6, 0,	1,  3,	1,	288, 192];... %48 Mbps
	[7, 0,	1,  3,	2,	288, 216];... %54 Mbps
];

%802.11n rates - IEEE 802.11-2012 Tables 20-30 to 20-37
% Only equal modulation MCS are included here
% MCS 32 is omitted (it's unused, as best I can tell)
mcs_info_11n = [...                          %Long / Short GI
    [ 0,	0,	1,	0,	0,	 52,	26];...  % 6.5 /  7.2 Mbps
    [ 1,	0,	1,	1,	0,	104,	52];...  %13.0 / 14.4 Mbps
    [ 2,	0,	1,	1,	2,	104,	78];...  %19.5 / 21.7 Mbps
    [ 3,	0,	1,	2,	0,	208,	104];... %26.0 / 28.9 Mbps
    [ 4,	0,	1,	2,	2,	208,	156];... %39.0 / 43.3 Mbps
    [ 5,	0,	1,	3,	1,	312,	208];... %52.0 / 57.8 Mbps
    [ 6,	0,	1,	3,	2,	312,	234];... %58.5 / 65.0 Mbps
    [ 7,	0,	1,	3,	3,	312,	260];... %65.0 / 72.2 Mbps
    [ 8,	0,	2,	0,	0,	 52,	26];...
    [ 9,	0,	2,	1,	0,	104,	52];...
    [10,	0,	2,	1,	2,	104,	78];...
    [11,	0,	2,	2,	0,	208,	104];...
