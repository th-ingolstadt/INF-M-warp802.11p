		1, 9, 1, 10, 3, 7, 6, 8, 4, 9, 6, 9, 4, 11, 10, 7, 6, 2, 7, 9,
		10, 6, 9, 2, 1, 2, 10, 9, 3, 2, 8, 5, 11, 6, 5, 3, 4, 5, 2, 11,
		5, 9, 9, 3, 8, 3, 2, 5, 1, 2, 6, 3, 1, 11, 9, 11, 11, 6, 11, 10,
		4, 11, 2, 2, 1, 4, 5, 2, 8, 11, 4, 9, 8, 2, 8, 10, 1, 2, 5, 11,
		11, 2, 2, 2, 7, 5, 3, 3, 3, 10, 7, 7, 8, 2, 7, 10, 2, 8, 10, 3,
		7, 6, 10, 1, 9, 7, 5, 9, 5, 4, 8, 5, 2, 1, 3, 10, 11, 6, 2, 6,
		11, 9, 11, 11, 3, 2, 5, 2, 9, 4, 5, 3, 9, 3, 9, 3, 7, 4, 8, 2,
		2, 3, 4, 5, 3, 8, 11, 5, 9, 9, 11, 3, 4, 9, 9, 11, 7, 7, 5, 4,
		7, 6, 6, 8, 1, 3, 11, 7, 1, 4, 1, 9, 8, 6, 7, 3, 5, 6, 10, 8,
		6, 10, 6, 3, 9, 11, 5, 3, 3, 1, 11, 9, 7, 5, 8, 11, 8, 2, 5, 8,
		4, 11, 7, 11, 5, 4, 10, 1, 2, 11, 8, 4, 10, 9, 11, 8, 7, 2, 11, 7,
		3, 11, 1, 1, 1, 6, 10, 5, 7, 7, 1, 5, 4, 3, 2, 2, 3, 3, 11, 3,
		6, 2, 11, 11, 2, 10, 1, 8, 10, 5, 3, 2, 10, 8, 9, 4, 3, 1, 1, 4,
		4, 6, 5, 11, 2, 9, 2, 9, 7, 6, 4, 5, 5, 3, 11, 8, 6, 3, 2, 10,
		4, 5, 1, 10, 4, 11, 1, 7, 7, 8, 4, 1, 4, 11, 9, 4, 9, 7, 1, 5,
		1, 9, 11, 8, 9, 7, 4, 9, 8, 5, 5, 2, 6, 3, 9, 8, 8, 9, 8, 10,
		6, 4, 11, 2, 3, 2, 9, 1, 6, 7, 5, 8, 10, 10, 11, 10, 1, 1, 10, 5,
		5, 4, 11, 8, 11, 6, 1, 10, 4, 10, 10, 7, 6, 10, 4, 3, 1, 2, 7, 10,
		9, 8, 5, 11, 9, 5, 7, 3, 3, 9, 4, 5, 9, 4, 5, 1, 9, 7, 2, 3,
		4, 1, 3, 1, 1, 8, 9, 5, 3, 4, 8, 3, 7, 3, 11, 7, 10, 11, 11, 6,
		2, 1, 5, 7, 11, 11, 10, 3, 5, 11, 6, 5, 4, 7, 2, 11, 8, 10, 6, 11,
		10, 2, 11, 8, 4, 10, 11, 8, 7, 2, 11, 9, 11, 8, 4, 9, 4, 7, 4, 6,
		9, 9, 5, 2, 1, 2, 11, 7, 7, 1, 3, 1, 2, 2, 2, 1, 3, 1, 9, 11,
		3, 7, 5, 2, 3, 3, 11, 6, 9, 3, 3, 10, 6, 11, 2, 11, 5, 5, 4, 2,
		9, 2, 10, 5};
...
void toggle_hop_vec(){
	static u8 curr_hop_vec = 0;
	curr_hop_vec = (curr_hop_vec + 1)%2;
...
void enable_hopping(){
	xil_printf("Enable Hopping\n");
	enable_hop = 1;
}

void disable_hopping(){
	xil_printf("Disable Hopping\n");
	enable_hop = 0;
}
...
inline int poll_hop(){
	...
	if(enable_hop){
		...
		if(next_channel != curr_channel){
			...
			//This will ensure that any currently-pending transmissions don't start while we are changing channels
...
int main(){
	...
	wlan_mac_low_set_hop_seq_toggle((void*)toggle_hop_vec);
