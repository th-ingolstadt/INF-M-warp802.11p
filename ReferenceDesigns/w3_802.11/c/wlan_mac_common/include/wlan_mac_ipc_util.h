...
#define IPC_MBOX_TX_MPDU_CONFIRM	3
#define IPC_MBOX_TX_MPDU_DONE		4
#define IPC_MBOX_HW_INFO			5
#define IPC_MBOX_CPU_STATUS			6
#define IPC_MBOX_CONFIG_RF_IFC		7
#define IPC_MBOX_CONFIG_MAC			8
#define IPC_MBOX_CONFIG_PHY_RX		9
#define IPC_MBOX_CONFIG_PHY_TX		10
