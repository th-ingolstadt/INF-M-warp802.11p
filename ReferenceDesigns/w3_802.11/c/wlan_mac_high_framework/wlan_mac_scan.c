...
static		scan_parameters_t 	gl_scan_parameters;
...
int wlan_mac_scan_init(){
	...
	gl_scan_parameters.channel_vec 				= NULL; //Note: If a user provides a non-NULL channel vector,
														//we will re-allocate this pointer. C allows a realloc
														//of a NULL pointer and treats this like a call to malloc.

	gl_scan_parameters.channel_vec_len 			= 0;
