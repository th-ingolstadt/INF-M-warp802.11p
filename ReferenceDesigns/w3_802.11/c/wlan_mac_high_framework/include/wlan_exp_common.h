...
//
#define DEFAULT_DEBUG_PRINT_LEVEL                          WLAN_EXP_PRINT_WARNING
...
//    b) Wait for WARP Ethernet interface to be ready before continuing boot
//
//       Values:
...
//
#define WARP_WAIT_FOR_ETH                                  0


//    c) Allow Ethernet Link speed to be negotiated
//
//       Values of WARP_NEGOTIATE_ETH_LINK_SPEED:
...
//            above.
//
#define WARP_NEGOTIATE_ETH_LINK_SPEED                      0


//    d) Transmit MTU size for packets generated by the node (aka. async packets)
//
//       Values of WARP_TX_ASYNC_PACKET_MTU_SIZE:
...
//
#define WARP_TX_ASYNC_PACKET_BUFFER_SIZE                   1516
...
//
#define WARP_DEFAULT_MAX_PACKET_WORDS                      320
...
#define WARP_CMD_TO_GRP(x)                                ((x) >> 24)
#define WARP_CMD_TO_CMDID(x)                              ((x) & 0xFFFFFF)
...
// 
// WARP Message Structures
//

// Command / Response Header
//     NOTE:  This conforms to the WARP Command / Response Wire Format:
