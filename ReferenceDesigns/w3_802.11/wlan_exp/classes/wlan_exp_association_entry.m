classdef wlan_exp_association_entry < handle_light

    % !!!! CLASS IS NOT COMPLETE !!!!!  - DO NOT USE

    %The WLAN Exp association class encapsulates all the values of an 802.11 assocation
    ...
    methods
        function obj = wlan_exp_association( node, values )
