classdef wlan_exp_association_table < handle_light


    % !!!! CLASS IS NOT COMPLETE !!!!!  - DO NOT USE


    %The WLAN Exp association table class encapsulates a list of association entries
    
    properties (SetAccess = protected)
        node;                  % Node association came from
    
        table;                 % Table of association entries
    ...
    methods
        function obj = wlan_exp_association_table( node, values )
        ...
        function out = wlan_exp_associationCmd(obj, varargin)
