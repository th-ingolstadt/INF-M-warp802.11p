# -*- coding: utf-8 -*-
#
# mango_wlan_exp documentation build configuration file, created by
...
import os
import sys
import wlan_exp.version as wlan_exp_version
...
copyright = u'2014, Mango Communications, Inc.'
...
version = wlan_exp_version.version_number
# The full version, including alpha/beta/rc tags.
release = wlan_exp_version.version
...
latex_documents = [
  ('index', 'mango_wlan_exp_docs.tex', u'mango_wlan_exp Documentation',
   u'Mango Communications, Inc.', 'manual'),
]
...
man_pages = [
    ('index', 'mango_wlan_exp', u'Mango 802.11 Reference Design Experiments Framework Documentation',
     [u'Mango Communications, Inc.'], 1)
]
...
texinfo_documents = [
  ('index', 'mango_wlan_exp', u'Mango 802.11 Reference Design Experiments Framework Documentation',
   u'Mango Communications, Inc.', 'mango_wlan_exp', u'Mango 802.11 Reference Design Experiments Framework Documentation',
   'Miscellaneous'),
]
...
#Check if the "doc_svn_ver.txt" file exists, written by the post-commit hook
if os.path.exists("../doc_svn_rev.txt"):
    try:
        with open("../doc_svn_rev.txt", 'r') as f:
            f_str = '-' + f.read().rstrip() #strip trailing CR-NUL
            release += f_str
